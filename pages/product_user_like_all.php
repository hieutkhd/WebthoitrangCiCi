...
$sql = "SELECT products.* FROM product_like INNER jOIN  products ON product_like.product_id = products.id ORDER BY id DESC ";
        ...
        <div class="container">
            ...
            <div class="col-md-9 bor">
                <section class="box-main1">
                    <h3 class="title-main" style="text-align: left;"><a href="javascript:void(0)">Sản phẩm yêu thích</a> </h3>
